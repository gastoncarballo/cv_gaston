...
// Oculto el menu una vez que selleciono un opción
...
//Ahora voy a guardar la cantidad de barritas que se van a ir pintando por barra
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalIlustrador = setInterval(function(){
            pintarBarra(ilustrador, 14, 5, intervalIlustrador);
        },100);
    }
}
